...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Team Idiots ⚡', url='https://t.me/Team_idiots'),
            InlineKeyboardButton('⚡ Request Group ⚡', url='https://t.me/+paiZV_f0j0k3MTNl')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('❤️️JOIN❤️️', url='https://t.me/Team_idiots') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
